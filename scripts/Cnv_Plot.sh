...
Rscript $path_Rscript'plot_summary_cnv_QC_run.R'  --post ${post} --pre ${pre} --sample_name ${sample_name} --sex $sex --outf cnv_${sample_name} --width_plot 20 --fold_fun $path_Rscript --inputdir $path
